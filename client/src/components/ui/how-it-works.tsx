  ...
  const defaultFeatures: Step[] = [
    {
      title: "Select Files 📁",
      description:
        "Choose any files, photos, videos, or documents from your device. No file size limits or compression.",
      colorTheme: "orange",
    },
    {
      title: "Create Session 🔗",
      description:
        "QuickTransfer generates a unique, temporary end-to-end encrypted session instant room.",
      colorTheme: "blue",
    },
    {
      title: "QR / Code Share 📱",
      description:
        "Display the 6-character connection code or QR code on your screen for the receiver to join.",
      colorTheme: "purple",
    },
    {
      title: "Receiver Connects 🔗",
      description:
        "The receiving device scans the QR code or types the 6-character code to establish direct connection.",
      colorTheme: "orange",
    },
    {
      title: "Sending Files 📤",
      description:
        "Files stream directly peer-to-peer via WebRTC (or encrypted relay fallback if firewalled).",
      colorTheme: "blue",
    },
    {
      title: "Transfer Complete ✓",
      description:
        "Files arrive directly in browser memory and download. No history or copies stored on servers.",
      colorTheme: "purple",
    },
  ];
